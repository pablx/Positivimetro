	...
	Chart.defaults.global.tooltips = {
		...
		callbacks: {
			...
			label: function(tooltipItem, data) {
				...
				if(label.indexOf("Propor")>=0||label.indexOf("Dif.")>=0)
					label += parseInt(tooltipItem.yLabel*1000)+' %';
				else{
					if(label.indexOf("Tiempo")>=0)
		...
		draw: function() {
			...
			if (opts.display) {
				...
				var drawLegendBox = function(x, y, legendItem) {
					...
					if(legendItem.text.indexOf("Propor")!=0&&legendItem.text.indexOf("Dif.")!=0){
